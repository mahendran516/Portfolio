...
const Home = () => {
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-black text-white flex flex-col items-center justify-center p-6">
      ...
      <div className="mt-3 flex space-x-4 animate-fadeIn " style={{animationDelay: '0.6s'}}>
          <Link to="/projects" className="inline-block bg-gradient-to-r from-purple-500 to-blue-500 hover:from-blue-500 hover:to-purple-500 text-white py-3 px-6 rounded-full font-semibold shadow-lg transform transition hover:scale-105 animate-fadeIn" style={{animationDelay: '0.4s'}} >Projects</Link>
